...
sam2_queue() {
  case "$1" in
    tv21_proj_sam21l_msehr_cos025|tv21_adapter_sam21l_msehr) echo 8gpu_tv21_main ;;
    tv5_proj_sam21l_msehr|tv11_proj_sam21l_msehr_cos025) echo 4gpu_size_scaling ;;
    tv21_proj_sam21l_image_only|tv21_proj_sam21l_hr025) echo 4gpu_loss_ablation ;;
    tv21_adapter_sam21l_msehr_cos025|tv21_proj_sam21bplus_msehr) echo 4gpu_adapter_teacher ;;
    tv5_adapter_sam21l_msehr|tv21_proj_sam21l_msehr_cos1) echo 4gpu_extra_adapter_cos ;;
