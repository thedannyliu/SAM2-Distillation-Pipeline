...
IMAGE_ROOT="${IMAGE_ROOT:-/group-volume/danny-dataset/SA-1B/images}"
SOURCE="${SOURCE:-sa1b}"
SAMPLE_PERCENT="${SAMPLE_PERCENT:-1}"
SEED="${SEED:-sam2_stage1_sa1b_1pct_v1}"
GPUS="${GPUS:-0,1,2,3,4,5,6,7}"
SKIP_FILE_SHA256="${SKIP_FILE_SHA256:-1}"

MANIFEST="${MANIFEST:-${ROOT}/manifests/sa1b_1pct_v1.parquet}"
CACHE_ROOT="${CACHE_ROOT:-${ROOT}/cache/stage1_teacher/sam2p1_large_sa1b_1pct_v1}"
RUN_DIR="${RUN_DIR:-${ROOT}/runs/stage1_mse_sa1b_1pct_8xh100}"
...
Important environment overrides:
  ...
  IMAGE_ROOT=/group-volume/danny-dataset/SA-1B/images
  GPUS=0,1,2,3,4,5,6,7
  SAMPLE_PERCENT=1
  SKIP_FILE_SHA256=1
  MANIFEST=/group-volume/danny-dataset/sam2_distill/manifests/sa1b_1pct_v1.parquet
  CACHE_ROOT=/group-volume/danny-dataset/sam2_distill/cache/stage1_teacher/sam2p1_large_sa1b_1pct_v1
